    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-5 md:px-12">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/auth"
            className="rounded-md bg-primary px-4 py-1.5 text-sm font-medium text-primary-foreground glow hover:opacity-90"
          >
            Get started
          </Link>
        </div>
      ...
      <section className="relative z-10 mx-auto max-w-5xl px-6 py-20 text-center md:py-32">
        <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-border bg-card/50 px-3 py-1 text-xs backdrop-blur">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          <Link
            to="/auth"
            className="rounded-md bg-primary px-6 py-3 font-medium text-primary-foreground glow hover:opacity-90"
          >
            Start harvesting signals
          </Link>
          <a
            href="#pipeline"
            className="rounded-md border border-border bg-card/50 px-6 py-3 font-medium backdrop-blur hover:bg-accent"
          >
            See the pipeline
          </a>
        </div>
      ...
      {/* Pipeline */}
      <section id="pipeline" className="relative z-10 mx-auto max-w-6xl px-6 py-16">
        <div className="mb-12 text-center">
          <p className="text-xs uppercase tracking-widest text-primary">Agentic workflow</p>
        ...
        <div className="grid gap-4 md:grid-cols-5">
          {[
            ...
            <div
              key={s.name}
              className="group relative rounded-2xl border border-border bg-card/50 p-5 backdrop-blur transition hover:border-primary/50 hover:glow"
            >
      ...
      {/* CTA */}
      <section className="relative z-10 mx-auto max-w-4xl px-6 pb-24 pt-8 text-center">
        <div className="rounded-3xl border border-border bg-gradient-to-br from-card/80 to-card/20 p-10 backdrop-blur glow-violet">
          <h2 className="text-3xl font-semibold md:text-4xl">
            Stop monitoring. Start closing.
          </h2>
          ...
          <Link
            to="/auth"
            className="mt-6 inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 font-medium text-primary-foreground glow hover:opacity-90"
          >
