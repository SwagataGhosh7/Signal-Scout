...
//#region node_modules/.nitro/vite/services/ssr/assets/theme-provider-vKK-mT73.js
...
function ThemeProvider({ children, defaultTheme = "system", storageKey = "vite-ui-theme", ...props }) {
	const [theme, setTheme] = (0, import_react.useState)(() => {
		if (typeof window !== "undefined") return window.localStorage.getItem(storageKey) || defaultTheme;
		return defaultTheme;
	});
